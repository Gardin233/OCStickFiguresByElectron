...
---@return table hitboxs 碰撞箱数据和顶点
function Character.getHitBox(id)end
---展示碰撞箱
---@param id string 角色唯一标识符
...
function Character.checkHit(id,x,y)end
---获取点坐标于碰撞箱间的距离
---@param id string 角色的唯一标识符
---@param x number 基于全屏的x坐标
---@param y number 基于全屏的y坐标
function Character.getPosToHitBoxInstance(id,x,y)end
---comment
---@param id string
...
---@param x number
---@param y number
---@param func "line"|"more"
function Character.moveTo(id,x,y,func)end
---comment
---@param id string 角色的唯一标识符
